...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\shane\Herd\bet-the-boys\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\shane\\Herd\\bet-the-boys\\public\\storage','ide-helper.filename',
...
'insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes','insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.config.SlevomatCodingStandard\\Sniffs\\Files\\LineLengthSniff.lineLimit',
'insights.config.SlevomatCodingStandard\\Sniffs\\Files\\LineLengthSniff.absoluteLineLimit','insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture','insights.requirements.min-style',
...
'queue.failed.table','saloon.default_sender','saloon.integrations_path','sanctum.stateful','sanctum.guard',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.odds_api.key','session.driver','session.lifetime',
...
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','inertia.ssr.enabled','inertia.ssr.url',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ODDS_API_KEY',);
